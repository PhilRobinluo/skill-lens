...
- [核心功能](#核心功能)
  ...
  - [CLAUDE.md 版本管理](#4-claudemd-版本管理)
  - [技能详情面板](#5-技能详情面板)
  - [社区技能追踪](#6-社区技能追踪)
  - [标签分类系统](#7-标签分类系统)
  - [更多浏览方式](#8-更多浏览方式)
  - [编排区 — 三个视图理解技能关系](#9-编排区--三个视图理解技能关系)
- [AI 智能功能](#ai-智能功能)
  - [AI 自动打标签](#ai-自动打标签)
  - [AI 工作流编排](#ai-工作流编排)
  - [AI 健康度报告](#ai-健康度报告)
...
技能透镜**只读取**你的 Skill 文件，**永远不会修改**它们。所有的标签、备注等编辑都保存在工具自己的 `data/registry.json` 文件里。

你可以随时删掉整个 skill-lens 文件夹，你的 Skill 文件不会少一个字。
...
- [ ] CLAUDE.md 路由表一键生成（从内容自动生成结构化的路由表视图）
- [ ] 编排画布与 CLAUDE.md 联动
- [ ] 批量操作 — 一次给多个 Skill 打标签
- [ ] 自动频率统计优化
- [ ] 更多 AI 分析能力
